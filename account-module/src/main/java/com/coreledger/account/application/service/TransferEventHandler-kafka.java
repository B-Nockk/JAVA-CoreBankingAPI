...
// import com.coreledger.shared.EventPublisher;
...
// LoggerFactory.getLogger(TransferEventHandler.class);
...
// Account source =
// loadAccountPort.findByAccountNumber(event.getSourceAccountNumber())
// .orElseThrow(() -> new
// AccountNotFoundException(event.getSourceAccountNumber()));
...
// source.creditTransfer(event.getAmount(), transferId + "-REVERSAL",
// "TRANSFER_SYSTEM");
// saveAccountPort.save(source);
